...
class HomeFragment : Fragment(), EmailAdapter.EmailAdapterListener {
    ...
    override fun onEmailClicked(cardView: View, email: Email) {
        ...
        val emailCardTransitionName = getString(R.string.email_card_detail_transition_name)
        val extras = FragmentNavigatorExtras(cardView to emailCardTransitionName)
